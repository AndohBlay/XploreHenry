        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Your perfect companion for planning memorable trips and discovering amazing destinations.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/itinerary" className="text-gray-400 hover:text-white">My Itinerary</Link></li>
            </ul>
          </div>
